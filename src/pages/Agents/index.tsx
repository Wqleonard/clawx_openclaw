...
function AddAgentDialog({
  ...
  onClose: () => void;
  onCreate: (name: string, options: { templateId?: string; sourceAgentId?: string; workspacePath?: string,inheritWorkspace: boolean }) => Promise<void>;
}) {
  const { t } = useTranslation('agents');
  ...
  const handleSubmit = async () => {
    ...
    try {
      const options = source === 'agent'
        ? { sourceAgentId: selectedAgentId, workspacePath: workspacePath || undefined,inheritWorkspace }
        : { templateId: selectedTemplateId, workspacePath: workspacePath || undefined,inheritWorkspace };
