...
Before CREATE / FILL / REFORMAT, always verify runtime dependencies first. Do not continue until required checks pass.
...
python -c "import reportlab, pypdf, matplotlib"

# 3) Verify Playwright availability
node -e "require('playwright'); console.log('playwright ok')"
# Optional: ensure Chromium is installed
npx playwright install chromium
```

If checks fail, install dependencies in PowerShell and then re-check:
- Python 3.9+
- Node.js 18+
- `python -m pip install reportlab pypdf matplotlib`
